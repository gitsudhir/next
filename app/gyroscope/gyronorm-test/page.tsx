...
export default function GyroNormTest() {
  ...
  const initializeGyroNorm = async () => {
    try {
      // Dynamically import gyronorm to avoid SSR issues
      const { GyroNorm } = await import('gyronorm');
      ...
      await gn.init({
        ...
        orientationBase: GyroNorm.GAME, // GAME
        decimalCount: 2,
        logger: undefined,
    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">GyroNorm.js Sensor Test</h1>
          <p className="mt-2 text-gray-600">Using gyronorm.js library for cross-device sensor compatibility</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          ...
          <div className="p-6">
                  ...
                  <div className="mt-6 p-4 bg-red-50 text-red-700 rounded-lg max-w-2xl mx-auto">
                    ...
                    <div className="mt-3 text-xs text-gray-600">
                      ...
                      <ul className="list-disc pl-5 mt-1 space-y-1">
                        <li>Missing FULLTILT.js dependency</li>
                        <li>Browser compatibility issues</li>
                        <li>Device sensor limitations</li>
                      </ul>
                    </div>
                  </div>
                )}
            ...
            {error && error.indexOf('FULLTILT') === -1 && (
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-600">
            <h2 className="text-xl font-bold text-white">About GyroNorm.js</h2>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-600 list-disc pl-5">
                  <li>If FULLTILT error occurs, try the proven approach</li>
                  <li>Make sure you&apos;re on a mobile device with sensors</li>
